...
<div class="col-xs-12 col-sm-2 label" data-label="LBL_VALOR">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="varchar" field="valor_c" colspan='3' >
{counter name="panelFieldCount" print=false}
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_OPPORTUNITIES_RESER_RESERVAS_1_FROM_OPPORTUNITIES_TITLE">
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="opportunities_reser_reservas_1_name"  >
{counter name="panelFieldCount" print=false}
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"opportunities_reser_reservas_1opportunities_ida","name":"opportunities_reser_reservas_1_name"}}{/literal}, 
"single", 
true
...
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"aos_products_reser_reservas_1aos_products_ida","name":"aos_products_reser_reservas_1_name"}}{/literal}, 
"single", 
true
...
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'document_name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'filename', 'varchar', true,'{/literal}{sugar_translate label='LBL_FILENAME' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'file_ext', 'varchar', false,'{/literal}{sugar_translate label='LBL_FILE_EXTENSION' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'file_mime_type', 'varchar', false,'{/literal}{sugar_translate label='LBL_MIME' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'uploadfile', 'file', false,'{/literal}{sugar_translate label='LBL_FILE_UPLOAD' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'active_date', 'date', true,'{/literal}{sugar_translate label='LBL_DOC_ACTIVE_DATE' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'exp_date', 'date', false,'{/literal}{sugar_translate label='LBL_DOC_EXP_DATE' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'category_id', 'enum', false,'{/literal}{sugar_translate label='LBL_SF_CATEGORY' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'subcategory_id', 'enum', false,'{/literal}{sugar_translate label='LBL_SF_SUBCATEGORY' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'status_id', 'enum', false,'{/literal}{sugar_translate label='LBL_DOC_STATUS' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'status', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOC_STATUS' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'descripcion_c', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPCION' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'valor_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_VALOR' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'opportunities_reser_reservas_1_name', 'relate', true,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_RESER_RESERVAS_1_FROM_OPPORTUNITIES_TITLE' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'aos_products_reser_reservas_1_name', 'relate', true,'{/literal}{sugar_translate label='LBL_AOS_PRODUCTS_RESER_RESERVAS_1_FROM_AOS_PRODUCTS_TITLE' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'reser_reservas_aos_product_categories_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_RESER_RESERVAS_AOS_PRODUCT_CATEGORIES_1_FROM_AOS_PRODUCT_CATEGORIES_TITLE' module='Reser_Reservas' for_js=true}{literal}' );
addToValidate('EditView', 'reser_reservas_contacts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_RESER_RESERVAS_CONTACTS_1_FROM_CONTACTS_TITLE' module='Reser_Reservas' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Reser_Reservas' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='Reser_Reservas' for_js=true}{literal}', 'assigned_user_id' );
addToValidateBinaryDependency('EditView', 'opportunities_reser_reservas_1_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Reser_Reservas' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_OPPORTUNITIES_RESER_RESERVAS_1_FROM_OPPORTUNITIES_TITLE' module='Reser_Reservas' for_js=true}{literal}', 'opportunities_reser_reservas_1opportunities_ida' );
addToValidateBinaryDependency('EditView', 'aos_products_reser_reservas_1_name', 'alpha', true,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Reser_Reservas' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_AOS_PRODUCTS_RESER_RESERVAS_1_FROM_AOS_PRODUCTS_TITLE' module='Reser_Reservas' for_js=true}{literal}', 'aos_products_reser_reservas_1aos_products_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_opportunities_reser_reservas_1_name']={"form":"EditView","method":"query","modules":["Opportunities"],"group":"or","field_list":["name","id"],"populate_list":["opportunities_reser_reservas_1_name","opportunities_reser_reservas_1opportunities_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['EditView_aos_products_reser_reservas_1_name']={"form":"EditView","method":"query","modules":["AOS_Products"],"group":"or","field_list":["name","id"],"populate_list":["aos_products_reser_reservas_1_name","aos_products_reser_reservas_1aos_products_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>{/literal}
