...
<div class="buttons">
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_EDIT_BUTTON_TITLE}" accessKey="{$APP.LBL_EDIT_BUTTON_KEY}" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='EditView';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Edit" id="edit_button" value="{$APP.LBL_EDIT_BUTTON_LABEL}">{/if} 
{if $bean->aclAccess("edit")}<input title="{$APP.LBL_DUPLICATE_BUTTON_TITLE}" accessKey="{$APP.LBL_DUPLICATE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='{$id}';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Duplicate" value="{$APP.LBL_DUPLICATE_BUTTON_LABEL}" id="duplicate_button">{/if} 
{if $bean->aclAccess("delete")}<input title="{$APP.LBL_DELETE_BUTTON_TITLE}" accessKey="{$APP.LBL_DELETE_BUTTON_KEY}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('{$APP.NTC_DELETE_CONFIRMATION}')) SUGAR.ajaxUI.submitForm(_form); return false;" type="submit" name="Delete" value="{$APP.LBL_DELETE_BUTTON_LABEL}" id="delete_button">{/if} 
{if $bean->aclAccess("edit") && $bean->aclAccess("delete")}<input title="{$APP.LBL_DUP_MERGE}" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='DetailView'; _form.return_id.value='{$id}'; _form.action.value='Step1'; _form.module.value='MergeRecords';SUGAR.ajaxUI.submitForm(_form);" type="button" name="Merge" value="{$APP.LBL_DUP_MERGE}" id="merge_duplicate_button">{/if} 
...
<li>{if $bean->aclAccess("detail")}{if !empty($fields.id.value) && $isAuditEnabled}<input id="btn_view_change_log" title="{$APP.LNK_VIEW_CHANGE_LOG}" class="button" onclick='open_popup("Audit", "600", "400", "&record={$fields.id.value}&module_name=Reser_Reservas", true, false,  {ldelim} "call_back_function":"set_return","form_name":"EditView","field_to_name_array":[] {rdelim} ); return false;' type="button" value="{$APP.LNK_VIEW_CHANGE_LOG}">{/if}{/if}</li>
</ul>        </li>
...
{/if} 
<span class="sugar_field" id="{$fields.valor_c.name}">{$fields.valor_c.value}</span>
{/if}
...
{if !$fields.opportunities_reser_reservas_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.opportunities_reser_reservas_1opportunities_ida.value)}
{capture assign="detail_url"}index.php?module=Opportunities&action=DetailView&record={$fields.opportunities_reser_reservas_1opportunities_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="opportunities_reser_reservas_1opportunities_ida" class="sugar_field" data-id-value="{$fields.opportunities_reser_reservas_1opportunities_ida.value}">{$fields.opportunities_reser_reservas_1_name.value}</span>
{if !empty($fields.opportunities_reser_reservas_1opportunities_ida.value)}</a>{/if}
{/if}
...
{if !$fields.aos_products_reser_reservas_1_name.hidden}
{counter name="panelFieldCount" print=false}

{if !empty($fields.aos_products_reser_reservas_1aos_products_ida.value)}
{capture assign="detail_url"}index.php?module=AOS_Products&action=DetailView&record={$fields.aos_products_reser_reservas_1aos_products_ida.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="aos_products_reser_reservas_1aos_products_ida" class="sugar_field" data-id-value="{$fields.aos_products_reser_reservas_1aos_products_ida.value}">{$fields.aos_products_reser_reservas_1_name.value}</span>
{if !empty($fields.aos_products_reser_reservas_1aos_products_ida.value)}</a>{/if}
{/if}
...
{if !$fields.descripcion_c.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.descripcion_c.name|escape:'html'|url2html|nl2br}">{$fields.descripcion_c.value|escape:'html'|escape:'html_entity_decode'|url2html|nl2br}</span>
{/if}
