...
addToValidate('EditView', 'opportunities_aos_product_categories_2_name', 'relate', false,'{/literal}{sugar_translate label='LBL_OPPORTUNITIES_AOS_PRODUCT_CATEGORIES_2_FROM_AOS_PRODUCT_CATEGORIES_TITLE' module='Opportunities' for_js=true}{literal}' );
