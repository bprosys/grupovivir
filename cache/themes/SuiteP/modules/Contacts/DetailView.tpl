...
{if !$fields.proyecto_de_interes_c.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.proyecto_de_interes_c.name}">{$fields.proyecto_de_interes_c.value}</span>
{/if}
...
{if !$fields.relacion_con_la_cuenta_c.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.relacion_con_la_cuenta_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.relacion_con_la_cuenta_c.name}" value="{ $fields.relacion_con_la_cuenta_c.options }">
{ $fields.relacion_con_la_cuenta_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.relacion_con_la_cuenta_c.name}" value="{ $fields.relacion_con_la_cuenta_c.value }">
{ $fields.relacion_con_la_cuenta_c.options[$fields.relacion_con_la_cuenta_c.value]}
{/if}
{/if}
