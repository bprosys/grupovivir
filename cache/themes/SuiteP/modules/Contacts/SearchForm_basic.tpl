...
<input type='text' name='{$fields.search_name_basic.name}' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='identificacion_c_basic' >{sugar_translate label='LBL_IDENTIFICACION' module='Contacts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{if strlen($fields.identificacion_c_basic.value) <= 0}
{assign var="value" value=$fields.identificacion_c_basic.default_value }
{else}
{assign var="value" value=$fields.identificacion_c_basic.value }
{/if}  
<input type='text' name='{$fields.identificacion_c_basic.name}' 
    id='{$fields.identificacion_c_basic.name}' size='30' 
    maxlength='255' 
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='email_basic' >{sugar_translate label='LBL_ANY_EMAIL' module='Contacts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
