...
{capture name="label" assign="label"}{sugar_translate label='LBL_BROKERABIERTO' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.brokerabierto_c.value) <= 0}
{assign var="value" value=$fields.brokerabierto_c.default_value }
{else}
{assign var="value" value=$fields.brokerabierto_c.value }
{/if}  
<input type='text' name='{$fields.brokerabierto_c.name}' 
id='{$fields.brokerabierto_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</div>
...
addToValidate('EditView', 'bugs_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_BUGS_ACCOUNTS_1_FROM_BUGS_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'ing_ingenieria_accounts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ING_INGENIERIA_ACCOUNTS_FROM_ING_INGENIERIA_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'broker_c', 'enum', false,'{/literal}{sugar_translate label='LBL_BROKER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('EditView', 'brokerabierto_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BROKERABIERTO' module='Accounts' for_js=true}{literal}' );
addToValidate('EditView', 'identificacion_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_IDENTIFICACION' module='Accounts' for_js=true}{literal}' );
