...
{capture name="label" assign="label"}{sugar_translate label='LBL_BROKER' module='Accounts'}{/capture}
{$label|strip_semicolon}:
...
addToValidate('form_QuickCreate_Accounts', 'first_name_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FIRST_NAME' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'bugs_accounts_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_BUGS_ACCOUNTS_1_FROM_BUGS_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'ing_ingenieria_accounts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ING_INGENIERIA_ACCOUNTS_FROM_ING_INGENIERIA_TITLE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'broker_c', 'enum', false,'{/literal}{sugar_translate label='LBL_BROKER' module='Accounts' for_js=true}{literal}' );
...
addToValidate('form_QuickCreate_Accounts', 'brokerabierto_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BROKERABIERTO' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'identificacion_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_IDENTIFICACION' module='Accounts' for_js=true}{literal}' );
