...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='document_name_advanced'>{sugar_translate label='LBL_NAME' module='Reser_Contrato'}</label>
                            </div>
            <div class="form-item">
...
<input type='text' name='{$fields.document_name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='active_date_advanced'>{sugar_translate label='LBL_DOC_ACTIVE_DATE' module='Reser_Contrato'}</label>
                            </div>
            <div class="form-item">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='aos_product_categories_reser_contrato_1_name_advanced'>{sugar_translate label='LBL_AOS_PRODUCT_CATEGORIES_RESER_CONTRATO_1_FROM_AOS_PRODUCT_CATEGORIES_TITLE' module='Reser_Contrato'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.aos_product_categories_reser_contrato_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.aos_product_categories_reser_contrato_1_name_advanced.name}" size="" value="{$fields.aos_product_categories_reser_contrato_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.aos_produc5b3degories_ida_advanced.name}" value="{$fields.aos_produc5b3degories_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.aos_product_categories_reser_contrato_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.aos_product_categories_reser_contrato_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"aos_produc5b3degories_ida_advanced","name":"aos_product_categories_reser_contrato_1_name_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.aos_product_categories_reser_contrato_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.aos_product_categories_reser_contrato_1_name_advanced.name}.value = ''; this.form.{$fields.aos_produc5b3degories_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='aos_products_reser_contrato_1_name_advanced'>{sugar_translate label='LBL_AOS_PRODUCTS_RESER_CONTRATO_1_FROM_AOS_PRODUCTS_TITLE' module='Reser_Contrato'}</label>
                            </div>
            <div class="form-item">
                                
<input type="text" name="{$fields.aos_products_reser_contrato_1_name_advanced.name}"  class="sqsEnabled"   id="{$fields.aos_products_reser_contrato_1_name_advanced.name}" size="" value="{$fields.aos_products_reser_contrato_1_name_advanced.value}" title='' autocomplete="off"  >
<input type="hidden"  id="{$fields.aos_products_reser_contrato_1aos_products_ida_advanced.name}" value="{$fields.aos_products_reser_contrato_1aos_products_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.aos_products_reser_contrato_1_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.aos_products_reser_contrato_1_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"aos_products_reser_contrato_1aos_products_ida_advanced","name":"aos_products_reser_contrato_1_name_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.aos_products_reser_contrato_1_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.aos_products_reser_contrato_1_name_advanced.name}.value = ''; this.form.{$fields.aos_products_reser_contrato_1aos_products_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='status_id_advanced'>{sugar_translate label='LBL_DOC_STATUS' module='Reser_Contrato'}</label>
                            </div>
            <div class="form-item">
...
{html_options id='status_id_advanced' name='status_id_advanced[]' options=$fields.status_id_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.status_id_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='exp_date_advanced'>{sugar_translate label='LBL_DOC_EXP_DATE' module='Reser_Contrato'}</label>
                            </div>
            <div class="form-item">
