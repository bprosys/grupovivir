...
<button type="button" name="btn_{$fields.aos_product_category_name_advanced.name}"   title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick='open_popup("{$fields.aos_product_category_name_advanced.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"aos_product_category_id_advanced","name":"aos_product_category_name_advanced"}}{/literal}, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.aos_product_category_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.aos_product_category_name_advanced.name}.value = ''; this.form.{$fields.aos_product_category_id_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='estado_c_advanced'>{sugar_translate label='LBL_ESTADO' module='AOS_Products'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='estado_c_advanced' name='estado_c_advanced[]' options=$fields.estado_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.estado_c_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='modelo_c_advanced'>{sugar_translate label='LBL_MODELO' module='AOS_Products'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.modelo_c_advanced.value) <= 0}
{assign var="value" value=$fields.modelo_c_advanced.default_value }
{else}
{assign var="value" value=$fields.modelo_c_advanced.value }
{/if}  
<input type='text' name='{$fields.modelo_c_advanced.name}' 
    id='{$fields.modelo_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''  tabindex='-1'      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='metraje_c_advanced'>{sugar_translate label='LBL_METRAJE' module='AOS_Products'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.metraje_c_advanced.value) <= 0}
{assign var="value" value=$fields.metraje_c_advanced.default_value }
{else}
{assign var="value" value=$fields.metraje_c_advanced.value }
{/if}  
<input type='text' name='{$fields.metraje_c_advanced.name}' 
    id='{$fields.metraje_c_advanced.name}' size='30' 
    maxlength='255' 
    value='{$value}' title=''  tabindex='-1'      >
                            </div>
        </div>
...
<script>
    ...
    {/literal}
</script>{literal}<script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['search_form_modified_by_name_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_created_by_name_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_assigned_user_name_advanced']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_contact_advanced']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_advanced","contact_id_advanced","contact_id_advanced","contact_id_advanced"],"required_list":["contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_aos_product_category_name_advanced']={"form":"search_form","method":"query","modules":["AOS_Product_Categories"],"group":"or","field_list":["name","id"],"populate_list":["aos_product_category_name_advanced","aos_product_category_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_rvsem_reservas_aos_products_1_name_advanced']={"form":"search_form","method":"query","modules":["rvsem_reservas"],"group":"or","field_list":["name","id"],"populate_list":["rvsem_reservas_aos_products_1_name_advanced","rvsem_reservas_aos_products_1rvsem_reservas_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_bugs_aos_products_1_name_advanced']={"form":"search_form","method":"query","modules":["Bugs"],"group":"or","field_list":["name","id"],"populate_list":["bugs_aos_products_1_name_advanced","bugs_aos_products_1bugs_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_documents_aos_products_1_name_advanced']={"form":"search_form","method":"query","modules":["Documents"],"group":"or","field_list":["name","id"],"populate_list":["documents_aos_products_1_name_advanced","documents_aos_products_1documents_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_ingen_ingenieria_aos_products_1_name_advanced']={"form":"search_form","method":"query","modules":["ingen_ingenieria"],"group":"or","field_list":["name","id"],"populate_list":["ingen_ingenieria_aos_products_1_name_advanced","ingen_ingenieria_aos_products_1ingen_ingenieria_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_ing_ingenieria_aos_products_name_advanced']={"form":"search_form","method":"query","modules":["ING_Ingenieria"],"group":"or","field_list":["name","id"],"populate_list":["ing_ingenieria_aos_products_name_advanced","ing_ingenieria_aos_productsing_ingenieria_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects['search_form_accounts_aos_products_1_name_advanced']={"form":"search_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["search_form_accounts_aos_products_1_name_advanced","accounts_aos_products_1accounts_ida_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["accounts_aos_products_1accounts_ida"],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>{/literal}