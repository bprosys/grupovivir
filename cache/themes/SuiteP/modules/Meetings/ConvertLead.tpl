...
onclick="toggleDisplay('createMeetings');if (typeof(addRemoveDropdownElement) == 'function') addRemoveDropdownElement('Meetings');{if !empty($def.select)}toggleMeetingsSelect();{/if}">
<script type="text/javascript">
