...
<input type='text' name='{$fields.name_advanced.name}' 
    ...
    value='{$value}' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='categoria_c_advanced'>{sugar_translate label='LBL_CATEGORIA' module='AOS_Product_Categories'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='categoria_c_advanced' name='categoria_c_advanced[]' options=$fields.categoria_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.categoria_c_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='estado_del_proyecto_c_advanced'>{sugar_translate label='LBL_ESTADO_DEL_PROYECTO' module='AOS_Product_Categories'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='estado_del_proyecto_c_advanced' name='estado_del_proyecto_c_advanced[]' options=$fields.estado_del_proyecto_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.estado_del_proyecto_c_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='ciudad_c_advanced'>{sugar_translate label='LBL_CIUDAD' module='AOS_Product_Categories'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='ciudad_c_advanced' name='ciudad_c_advanced[]' options=$fields.ciudad_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.ciudad_c_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='cantunid_c_advanced'>{sugar_translate label='LBL_CANTUNID' module='AOS_Product_Categories'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.cantunid_c_advanced.value) <= 0}
{assign var="value" value=$fields.cantunid_c_advanced.default_value }
{else}
{assign var="value" value=$fields.cantunid_c_advanced.value }
{/if}  
<input type='text' name='{$fields.cantunid_c_advanced.name}' 
    id='{$fields.cantunid_c_advanced.name}' size='30' 
