...
<div class="row">
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='numerodeidentificacion_c_advanced'>{sugar_translate label='LBL_NUMERODEIDENTIFICACION' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{if strlen($fields.numerodeidentificacion_c_advanced.value) <= 0}
{assign var="value" value=$fields.numerodeidentificacion_c_advanced.default_value }
{else}
{assign var="value" value=$fields.numerodeidentificacion_c_advanced.value }
{/if}  
<input type='text' name='{$fields.numerodeidentificacion_c_advanced.name}' 
    id='{$fields.numerodeidentificacion_c_advanced.name}' size='30' 
    maxlength='255' 
...
{html_options id='lead_source_advanced' name='lead_source_advanced[]' options=$fields.lead_source_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.lead_source_advanced.value}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='proyectointeres1_c_advanced'>{sugar_translate label='LBL_PROYECTOINTERES1' module='Leads'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='proyectointeres1_c_advanced' name='proyectointeres1_c_advanced[]' options=$fields.proyectointeres1_c_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.proyectointeres1_c_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_by_advanced'>{sugar_translate label='LBL_CREATED' module='Leads'}</label>
                            </div>
            <div class="form-item">
