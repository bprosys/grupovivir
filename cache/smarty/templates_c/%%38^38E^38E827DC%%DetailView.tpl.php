<?php /* Smarty version 2.6.29, created on 2018-08-24 07:52:33
         compiled from cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 42, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 51, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 110, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 298, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 103, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 223, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 223, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Reser_Reservas/DetailView.tpl', 223, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='Reser_Reservas'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<div class="col-xs-12 col-sm-10 detail-view-field inlineEdit" type="varchar" field="valor_c" colspan='3' >

<?php if (! $this->_tpl_vars['fields']['valor_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['valor_c']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['valor_c']['value']; ?>
</span>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="opportunities_reser_reservas_1_name"  >

<?php if (! $this->_tpl_vars['fields']['opportunities_reser_reservas_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['opportunities_reser_reservas_1opportunities_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=Opportunities&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['opportunities_reser_reservas_1opportunities_ida']['value']; ?>
...
"><?php endif; ?>
<span id="opportunities_reser_reservas_1opportunities_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['opportunities_reser_reservas_1opportunities_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['opportunities_reser_reservas_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['opportunities_reser_reservas_1opportunities_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="relate" field="aos_products_reser_reservas_1_name"  >

<?php if (! $this->_tpl_vars['fields']['aos_products_reser_reservas_1_name']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['aos_products_reser_reservas_1aos_products_ida']['value'] )): ?>
<?php ob_start(); ?>index.php?module=AOS_Products&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['aos_products_reser_reservas_1aos_products_ida']['value']; ?>
<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="aos_products_reser_reservas_1aos_products_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['aos_products_reser_reservas_1aos_products_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['aos_products_reser_reservas_1_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['aos_products_reser_reservas_1aos_products_ida']['value'] )): ?></a><?php endif; ?>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="text" field="descripcion_c"  >

<?php if (! $this->_tpl_vars['fields']['descripcion_c']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['descripcion_c']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['fields']['descripcion_c']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'html') : smarty_modifier_escape($_tmp, 'html')))) ? $this->_run_mod_handler('escape', true, $_tmp, 'html_entity_decode') : smarty_modifier_escape($_tmp, 'html_entity_decode')))) ? $this->_run_mod_handler('url2html', true, $_tmp) : url2html($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</span>
<?php endif; ?>
