<?php /* Smarty version 2.6.29, created on 2018-08-22 10:22:47
         compiled from cache/themes/SuiteP/modules/Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 52, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 106, false),array('modifier', 'lookup', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 331, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 433, false),array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 68, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 89, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 111, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 142, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 334, false),array('function', 'sugar_getjspath', 'cache/themes/SuiteP/modules/Contacts/EditView.tpl', 570, false),)), $this); ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_IDENTIFICACION','module' => 'Contacts'), $this);?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROYECTO_DE_INTERES','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['proyecto_de_interes_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['proyecto_de_interes_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ESTADO','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPCION','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RELACION_CON_LA_CUENTA','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
'></script>
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
"
id="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
"
title=''           
>
<?php if (isset ( $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['value'] ) && $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['options'],'selected' => $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['options'],'selected' => $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
"
id="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
"
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
()"><span class="suitepicon suitepicon-action-clear"></span></button>
</span>
<?php echo '
<script>
...
(function (){
    var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
<?php echo '");
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
    ...
    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-input');
    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
-image');
    SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['relacion_con_la_cuenta_c']['name']; ?>
');
...
<?php echo '\' );
addToValidate(\'EditView\', \'descripcion_c\', \'text\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPCION','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'estado_c\', \'dynamicenum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ESTADO','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'proyecto_de_interes_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROYECTO_DE_INTERES','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'reser_reservas_contacts_1_name\', \'relate\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RESER_RESERVAS_CONTACTS_1_FROM_RESER_RESERVAS_TITLE','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'proyectoint_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PROYECTOINT','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'relacion_con_la_cuenta_c\', \'dynamicenum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_RELACION_CON_LA_CUENTA','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_IDENTIFICACION','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
