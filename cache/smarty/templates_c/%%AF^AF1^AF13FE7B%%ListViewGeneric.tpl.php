...
/* Smarty version 2.6.29, created on 2018-08-22 07:56:27
...
<?php else: ?>EditView<?php endif; ?><?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('action', ob_get_contents());ob_end_clean(); ?>
				...
				<?php else: ?>
					<td>
                        ...
                        if ($this->_tpl_vars['pageData']['rowAccess'][$this->_tpl_vars['id']]['edit'] && ! empty ( $this->_tpl_vars['quickViewLinks'] )): ?>
...
"
							>
                                <?php ob_start(); ?>
                                <?php echo smarty_function_sugar_translate(array('label' => 'LNK_EDIT'), $this);?>
...
<?php echo ' align=\''; ?>
<?php 
	echo ((is_array($_tmp=@$this->_tpl_vars['params']['align'])) ? $this->_run_mod_handler('default', true, $_tmp, 'left') : smarty_modifier_default($_tmp, 'left')); 
?>
<?php 
	echo '\' valign="top" type="'; 
?>
<?php 
	echo $this->_tpl_vars['displayColumns'][$this->_tpl_vars['col']]['type']; 
?>
<?php 
	echo '" field="'; 
?>
<?php 
	echo ((is_array($_tmp=$this->_tpl_vars['col'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)); 
?>
<?php 
	echo '" class="'; 
?>
<?php 
	echo $this->_tpl_vars['hide']; 
?>
<?php 
	echo ' '; 
?>
<?php
if ( 
		$this->_tpl_vars['inline_edit'] && 
			(   $this->_tpl_vars['displayColumns'][$this->_tpl_vars['col']]['inline_edit'] == 1 || 
				!isset ( $this->_tpl_vars['displayColumns'][$this->_tpl_vars['col']]['inline_edit'] ) )
	): 
?>
	
	<?php 
	
	//http://bprosys.online/grupovivir/index.php?module=Leads&action=index&parentTab=Todo&ajax_load=1&loadLanguageJS=1
	if( substr_count($actual_link, 'module=Leads')>0 ) //Solo el modulo prospectos
		echo 'inlineEdit';
	else
		echo 'inlineEdit'; 
	?>
...
<?php 
if (( $this->_tpl_vars['params']['type'] == 'teamset' )): 
?>
<?php 
	echo 'nowrap'; 
?>
...
?>
<?php 
if (preg_match ( '/PHONE/' , $this->_tpl_vars['col'] )): ?>
		<?php echo ' phone'; ?>
<?php endif; ?>

<?php 
//Fin etiqueta inicio html '>
echo '">'; 
?>
...
?>
	...
	?>
		...
		<?php echo ''; ?>
		<?php echo (
				(	is_array($_tmp=@$this->_tpl_vars['params']['module']))  ? 
					$this->_run_mod_handler
					(
							'default', 
							true, $_tmp, 
							@$this->_tpl_vars['pageData']['bean']['moduleDir']
