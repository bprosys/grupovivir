<?php /* Smarty version 2.6.29, created on 2018-08-23 20:16:44
         compiled from cache/themes/SuiteP/modules/AOS_Products/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_basic.tpl', 31, false),array('function', 'math', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_basic.tpl', 32, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_basic.tpl', 38, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_basic.tpl', 89, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/AOS_Products/SearchForm_basic.tpl', 128, false),)), $this); ?>
...
' title=''  tabindex='-1'      accesskey='9'  >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='aos_product_category_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AOS_PRODUCT_CATEGORYS_NAME','module' => 'AOS_Products'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<input type="text" name="<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['aos_product_category_id_basic']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['aos_product_category_id_basic']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"aos_product_category_id_basic","name":"aos_product_category_name_basic"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['aos_product_category_name_basic']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['aos_product_category_id_basic']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='estado_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ESTADO','module' => 'AOS_Products'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php echo smarty_function_html_options(array('id' => 'estado_c_basic','name' => 'estado_c_basic[]','options' => $this->_tpl_vars['fields']['estado_c_basic']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['estado_c_basic']['value']), $this);?>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='modelo_c_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODELO','module' => 'AOS_Products'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php if (strlen ( $this->_tpl_vars['fields']['modelo_c_basic']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['modelo_c_basic']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['modelo_c_basic']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['modelo_c_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['modelo_c_basic']['name']; ?>
' size='30' 
    maxlength='255' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''  tabindex='-1'      >
