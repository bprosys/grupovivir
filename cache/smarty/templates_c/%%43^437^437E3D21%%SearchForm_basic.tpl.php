<?php /* Smarty version 2.6.29, created on 2018-08-23 10:07:30
         compiled from cache/themes/SuiteP/modules/rvsem_reservas/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/rvsem_reservas/SearchForm_basic.tpl', 31, false),array('function', 'math', 'cache/themes/SuiteP/modules/rvsem_reservas/SearchForm_basic.tpl', 32, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/rvsem_reservas/SearchForm_basic.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/rvsem_reservas/SearchForm_basic.tpl', 86, false),)), $this); ?>
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='rvsem_reservas_aos_products_1_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_RVSEM_RESERVAS_AOS_PRODUCTS_1_FROM_AOS_PRODUCTS_TITLE','module' => 'rvsem_reservas'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<input type="text" name="<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1aos_products_idb_basic']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1aos_products_idb_basic']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_TITLE']; ?>
" class="button firstChild" value="<?php echo $this->_tpl_vars['APP']['LBL_SELECT_BUTTON_LABEL']; ?>
" onclick='open_popup("<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['module']; ?>
", 600, 400, "", true, false, <?php echo '{"call_back_function":"set_return","form_name":"search_form","field_to_name_array":{"id":"rvsem_reservas_aos_products_1aos_products_idb_basic","name":"rvsem_reservas_aos_products_1_name_basic"}}'; ?>
, "single", true);'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button lastChild" onclick="this.form.<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1_name_basic']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['rvsem_reservas_aos_products_1aos_products_idb_basic']['name']; ?>
...
"><span class="suitepicon suitepicon-action-clear"></span></button>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='document_name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'rvsem_reservas'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
