...
' title=''  tabindex='-1'      accesskey='9'  >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='categoria_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CATEGORIA','module' => 'AOS_Product_Categories'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'categoria_c_advanced','name' => 'categoria_c_advanced[]','options' => $this->_tpl_vars['fields']['categoria_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['categoria_c_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='estado_del_proyecto_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ESTADO_DEL_PROYECTO','module' => 'AOS_Product_Categories'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'estado_del_proyecto_c_advanced','name' => 'estado_del_proyecto_c_advanced[]','options' => $this->_tpl_vars['fields']['estado_del_proyecto_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['estado_del_proyecto_c_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='ciudad_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CIUDAD','module' => 'AOS_Product_Categories'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'ciudad_c_advanced','name' => 'ciudad_c_advanced[]','options' => $this->_tpl_vars['fields']['ciudad_c_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['ciudad_c_advanced']['value']), $this);?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='cantunid_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CANTUNID','module' => 'AOS_Product_Categories'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php if (strlen ( $this->_tpl_vars['fields']['cantunid_c_advanced']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['cantunid_c_advanced']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['cantunid_c_advanced']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['cantunid_c_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['cantunid_c_advanced']['name']; ?>
' size='30' 
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_created_by_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_assigned_user_name_advanced\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_parent_category_name_advanced\']={"form":"search_form","method":"query","modules":["AOS_Product_Categories"],"group":"or","field_list":["name","id"],"populate_list":["parent_category_name_advanced","parent_category_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_opportunities_aos_product_categories_2_name_advanced\']={"form":"search_form","method":"query","modules":["Opportunities"],"group":"or","field_list":["name","id"],"populate_list":["opportunities_aos_product_categories_2_name_advanced","opportunities_aos_product_categories_2opportunities_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_ing_ingenieria_aos_product_categories_1_name_advanced\']={"form":"search_form","method":"query","modules":["ING_Ingenieria"],"group":"or","field_list":["name","id"],"populate_list":["ing_ingenieria_aos_product_categories_1_name_advanced","ing_ingenieria_aos_product_categories_1ing_ingenieria_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};sqs_objects[\'search_form_reser_reservas_aos_product_categories_1_name_advanced\']={"form":"search_form","method":"query","modules":["Reser_Reservas"],"group":"or","field_list":["name","id"],"populate_list":["reser_reservas_aos_product_categories_1_name_advanced","reser_reservas_aos_product_categories_1reser_reservas_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Sin coincidencias"};</script>'; ?>