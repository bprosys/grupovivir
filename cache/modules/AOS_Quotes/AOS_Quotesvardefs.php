<?php 
 $GLOBALS["dictionary"]["AOS_Quotes"]=array (
  ...
  array (
    ...
    'aos_products_aos_quotes_1_name' => 
    array (
    ...
    'aos_products_aos_quotes_1aos_products_ida' => 
    array (
    ...
    array (
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotesvalor_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'valor_de_cuota_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Valor de Cuota',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'valor_de_cuota_c',
      'vname' => 'LBL_VALOR_DE_CUOTA',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotesvalor_de_cuota_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'porcentaje_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Porcentaje',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'porcentaje_c',
      ...
      'enable_range_search' => false,
      'precision' => '8',
      'id' => 'AOS_Quotesporcentaje_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'cuotas_mensuales_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Cuotas Mensuales',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'cuotas_mensuales_c',
      'vname' => 'LBL_CUOTAS_MENSUALES',
      'type' => 'int',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'AOS_Quotescuotas_mensuales_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'leads_aos_quotes_1' => 
    array (
    ...
    'saldo_abono_inicial_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Saldo Abono Inicial',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'saldo_abono_inicial_c',
      'vname' => 'LBL_SALDO_ABONO_INICIAL',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotessaldo_abono_inicial_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'cuota_inicial_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Cuota Inicial',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'cuota_inicial_c',
      'vname' => 'LBL_CUOTA_INICIAL',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotescuota_inicial_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'valor_separacion_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Valor Separacion',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'valor_separacion_c',
      'vname' => 'LBL_VALOR_SEPARACION',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotesvalor_separacion_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'credito_c' => 
    array (
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotescredito_c',
      'custom_module' => 'AOS_Quotes',
    ),
    'monto_a_firma_de_contrato_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Monto a Firma de Contrato',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'monto_a_firma_de_contrato_c',
      'vname' => 'LBL_MONTO_A_FIRMA_DE_CONTRATO',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'AOS_Quotesmonto_a_firma_de_contrato_c',
      'custom_module' => 'AOS_Quotes',
    ),
  ),
  'relationships' => 
