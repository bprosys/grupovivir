...
class Reser_ReservasViewDetail extends ViewDetail {
     ...
     */
    function Reser_ReservasViewDetail(){
	...
	function display(){
		$this->populateReservasTemplates();
		$this->displayPopupHtml();
		parent::display();
	}

	function populateReservasTemplates(){
		global $app_list_strings;

		$sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted = 0 AND type='Reser_Reservas' AND active = 1";
